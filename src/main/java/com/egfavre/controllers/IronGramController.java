...
public class IronGramController {
    ...
    public String upload (MultipartFile file, String receiver, Integer timeLimit, String show, HttpSession session) throws Exception {
        ...
        Photo photo = new Photo(sender, rec, photoFile.getName(), timeLimit, null, show);
        photos.save(photo);
